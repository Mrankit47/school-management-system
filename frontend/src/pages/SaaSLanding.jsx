    ...
    <div className="min-h-screen bg-white font-inter text-slate-800 hero-gradient selection:bg-blue-100 selection:text-blue-900">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            ...
            <div>
              <p className="font-outfit text-lg font-bold text-slate-900 tracking-tight leading-none">
                School Conduct
              </p>
              <p className="text-[10px] uppercase tracking-widest font-bold text-school-azure mt-1">
                Enterprise SaaS
              </p>
            </div>
          </div>
            ...
            <div className="relative group hidden md:block">
              ...
              <div className="absolute top-full right-0 pt-2 w-48 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300 z-[60]">
                <div className="bg-white border border-slate-100 rounded-2xl shadow-2xl overflow-hidden p-2">
                  ...
                  >
                    <span className="w-6 h-6 bg-blue-50 rounded-lg flex items-center justify-center text-[10px]">
                      🏢
                    </span>
                    Superadmin Login
                  </button>
                  <button
                    ...
                    className="w-full text-left px-4 py-3 text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-school-navy rounded-xl transition-colors flex items-center gap-3"
                  >
                    <span className="w-6 h-6 bg-indigo-50 rounded-lg flex items-center justify-center text-[10px]">
                      💼
                    </span>
                    Dealer Login
                  </button>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white border border-slate-100 rounded-[2.5rem] p-4 shadow-2xl animate-float">
              ...
              <div className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-5 border border-slate-50 flex items-center gap-4 max-w-[200px]">
                <div className="w-10 h-10 rounded-full bg-green-500/10 flex items-center justify-center text-green-600 text-lg">
                  ✓
                </div>
                <div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 border border-slate-50 flex items-center gap-4 max-w-[200px]">
                <div className="w-10 h-10 rounded-full bg-school-navy/10 flex items-center justify-center text-school-navy text-lg">
                  ✈
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-900">
      ...
      <section className="py-32 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <p className="text-[10px] font-extrabold text-school-azure uppercase tracking-[0.3em] mb-4">
              The Platform Standard
            </p>
            <h2 className="font-outfit text-4xl font-bold text-slate-900 mb-6">
              Engineered for Transparency
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Our core infrastructure provides the stability your school needs,
              with the flexibility to adapt to existing pedagogical workflows.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto bg-school-navy rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-900/20">
          ...
          <div className="relative z-10">
            <h2 className="font-outfit text-4xl md:text-5xl font-bold text-white mb-8">
              Ready to evolve your <br className="hidden md:block" /> school
              management?
            </h2>
            <p className="text-white/60 mb-12 max-w-xl mx-auto text-lg leading-relaxed">
              Join over 100 institutions leveraging our technology to drive
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500">
              Send us an enquiry and our team will get back to you within 24
              hours.
            </p>
          </div>
          ...
          <form
            ...
            className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100"
          >
            ...
            <div className="md:col-span-2 mt-2">
              ...
              {enquiryStatus === "success" && (
                <p className="text-center text-green-600 text-xs font-bold mt-4 animate-float">
                  ✓ {enquiryMsg}
                </p>
              )}
              {enquiryStatus === "error" && (
      ...
      <footer className="py-12 border-t border-slate-100 text-center">
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest leading-loose">
          © {new Date().getFullYear()} School Conduct Multi-Tenant
          Infrastructure. <br />
