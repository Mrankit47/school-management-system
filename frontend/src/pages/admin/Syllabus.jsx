...
export default function AdminSyllabus() {
  ...
  const filteredSubjects = useMemo(() => {
    ...
    return allSubjects.filter(
      (s) => String(s.class_ref) === String(createForm.class_id),
    );
  ...
  const onCreate = async (e) => {
    ...
    try {
      ...
      await api.post("syllabus/control/", fd, {
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      await api.patch(`syllabus/control/${editId}/`, fd, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      setEditOpen(false);
      loadData();
  ...
  return (
    ...
    >
      <div className="dashboard-shell" style={{ marginBottom: 20 }}>
        ...
        >
          Full central control over school syllabus.
        </p>
      </div>
      ...
      >
        ...
        >
          <h2 style={{ margin: "0 0 16px", fontSize: 18, fontWeight: 1000 }}>
            Upload New Syllabus
          </h2>
          <form onSubmit={onCreate} style={{ display: "grid", gap: 12 }}>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setCreateForm({ ...createForm, subject_id: e.target.value })
                }
                required
              >
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {s.class_name} • {s.subject_name} • By{" "}
                      {s.uploaded_by_name}
                    </div>
                  </div>
