...
>>>>>>> 92f67f0882aee1dc0c8b0ac2cf8decd6c701d545
  ...
  const inputClasses =
    "w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-school-navy/5 outline-none focus:bg-white focus:border-school-navy/20 transition-all font-medium";
  const labelClasses =
    "text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1 mb-1 block";
              ...
              {viewTeacher ? (
                <div className="space-y-8">
                  <div className="flex items-center gap-6 pb-8 border-b border-slate-100">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-school-text">
                        {viewTeacher.name}
                      </h4>
                      <p className="text-school-navy font-bold uppercase tracking-widest text-xs mt-1">
