        ...
        <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="group relative bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-school-blue/10 transition-all duration-500 cursor-default hover:-translate-y-2 overflow-hidden"
              >
                <div
                ...
                <div className="flex items-center gap-5 relative z-10">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-2xl shadow-lg ${stat.shadow} group-hover:rotate-6 transition-transform duration-500`}
                  >
                    {stat.icon}
                  </div>
                  <div>
                    ...
                    <p className="text-3xl font-poppins font-black text-school-text">
