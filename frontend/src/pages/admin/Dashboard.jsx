...
const AdminDashboard = () => {
  ...
  const parentPhoneDigits = (formData.parent_contact_number || "")
    .replace(/\D/g, "")
    .slice(0, 10);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const f_digits = (formData.father_contact || "")
        .replace(/\D/g, "")
        .slice(0, 10);
      const m_digits = (formData.mother_contact || "")
        .replace(/\D/g, "")
        .slice(0, 10);
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {/* Header Section */}
      <div className="relative overflow-hidden bg-white/80 backdrop-blur-xl p-4 sm:p-10 rounded-2xl sm:rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 mb-6 sm:mb-10 group transition-all duration-500 hover:shadow-2xl hover:shadow-school-blue/5">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
          <div className="flex items-center gap-4 sm:gap-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-school-navy to-school-blue flex items-center justify-center text-2xl sm:text-3xl shadow-xl shadow-school-navy/20">
              🛡️
            </div>
            <div>
              <h1 className="text-xl sm:text-2xl md:text-4xl font-poppins font-black text-school-text tracking-tight">
                Welcome{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-school-navy to-school-blue">
                  Admin Dashboard
                </span>
              </h1>
              <p className="text-[10px] sm:text-xs md:text-sm text-school-body font-bold mt-1 opacity-70">
                Management Overview & Academic Control Center •{" "}
      ...
      {!isFormOpen && (
        <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-700">
            ...
            {[
              {
                ...
                value: studentsCount,
                icon: "🎓",
                color: "from-blue-500 to-school-blue",
              ...
              <div
                key={i}
                className="group relative bg-white/80 backdrop-blur-xl p-3.5 sm:p-8 rounded-xl sm:rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-school-blue/10 transition-all duration-500 cursor-default hover:-translate-y-2 overflow-hidden"
              >
                <div
                  className={`absolute top-0 left-0 w-2 h-full bg-gradient-to-b ${stat.color} opacity-0 group-hover:opacity-100 transition-opacity`}
                ></div>
                <div className="flex items-center gap-3 sm:gap-5 relative z-10">
                  <div
                    className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-lg sm:text-2xl shadow-lg ${stat.shadow} group-hover:rotate-6 transition-transform duration-500`}
                  >
                    {stat.icon}
                  </div>
                  <div>
                    <p className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-wider sm:tracking-[0.2em] mb-0.5 sm:mb-1">
                      {stat.label}
                    </p>
                    <p className="text-base sm:text-3xl font-poppins font-black text-school-text">
                      {studentsLoading ? "..." : stat.value}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 bg-white/50 backdrop-blur-md p-4 sm:p-8 rounded-2xl sm:rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/30">
              <div className="flex items-start justify-between mb-8 gap-4 flex-wrap">
                <div>
                  <h3 className="font-poppins font-bold text-school-text text-lg">
                    School Gallery Highlights
                  </h3>
                  <p className="text-xs text-slate-400">
                    Auto-rotating highlights from your secure gallery
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 bg-white/80 backdrop-blur-xl p-4 sm:p-8 rounded-2xl sm:rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden group hover:shadow-2xl hover:shadow-school-blue/10 transition-all duration-500">
              ...
              <div className="mt-6 sm:mt-10 space-y-3 sm:space-y-5">
                ...
                <div className="p-3 sm:p-4 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all group/event cursor-pointer">
                  <div className="flex gap-3 sm:gap-4 items-center">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs font-black text-slate-800 group-hover/event:text-school-navy transition-colors">
                        Exam Prep Week
                      </span>
      ...
      {isFormOpen && (
        <div className="max-w-4xl mx-auto bg-white rounded-2xl sm:rounded-3xl border border-slate-100 shadow-xl overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
          <div className="p-4 sm:p-8 bg-slate-900 text-white relative">
            <h3 className="text-lg sm:text-2xl font-bold">New Student Registration</h3>
            <p className="text-slate-400 text-xs sm:text-sm mt-1">
              Fill in the details to create a new student account.
            </p>
            <div className="absolute right-4 top-4 sm:right-8 sm:top-8 opacity-20 text-4xl sm:text-6xl">🎓</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <span className="w-8 h-8 rounded-lg bg-school-blue/10 flex items-center justify-center text-school-blue font-bold">
                  01
                </span>
                <h4 className="font-bold text-school-text uppercase tracking-wider text-sm">
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-center gap-4">
                <span className="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500 font-bold">
                  02
                </span>
                <h4 className="font-bold text-school-text uppercase tracking-wider text-sm">
                  Academic Details
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-center gap-4">
                <span className="w-8 h-8 rounded-lg bg-amber-500/10 flex items-center justify-center text-amber-500 font-bold">
                  03
                </span>
                <h4 className="font-bold text-school-text uppercase tracking-wider text-sm">
                  Guardian & Address
            ...
            <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
              <span
                className={`text-sm font-bold ${message.includes("Error") ? "text-red-500" : "text-emerald-500"}`}
              >
                {message}
              </span>
