    ...
    <div className="p-4 md:p-8 space-y-10 animate-in fade-in duration-500 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-2">
          <h1 className="text-5xl font-black text-school-navy tracking-tight">
            School Highlights
          </h1>
          <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-xs">
            Capturing perfection, one moment at a time.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-black text-school-navy">
            ...
            <div className="space-y-6 flex flex-col justify-center">
              <div className="space-y-2">
                ...
                />
                <p className="text-[9px] font-bold text-slate-300 italic ml-1">
                  * If left empty, filenames will be used as titles.
                </p>
              </div>
            ...
            <div className="pt-8 border-t border-slate-50">
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
                {previews.map((url, idx) => (
                  <div
                    key={idx}
                    className="relative aspect-square rounded-2xl overflow-hidden group border border-slate-100 shadow-sm animate-in zoom-in duration-300"
                  >
                    <img
                      src={url}
                      alt="Preview"
      ...
      {loading ? (
        ...
        <div className="py-32 text-center bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/20">
          <div className="text-7xl mb-6 grayscale opacity-20 transform hover:scale-110 transition-transform">
            🖼️
          </div>
          ...
          <p className="text-slate-400 font-bold max-w-sm mx-auto mt-2 leading-relaxed uppercase text-[10px] tracking-widest">
            Experience will populate soon once the administration completes
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {images.map((img) => (
                <div
                  key={img.id}
                  className="group bg-white rounded-[2rem] border border-slate-100 p-3 shadow-xl shadow-slate-200/40 hover:shadow-2xl transition-all duration-500"
                >
                  ...
                  <div className="px-2">
                    <p className="text-xs font-black text-school-navy truncate">
                      {img.title}
                    </p>
