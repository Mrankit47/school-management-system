...
const StudentMessaging = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const res = await api.post(
        `communication/doubts/${activeConvId}/`,
        form,
        {
  ...
  const handleEdit = async (msgId) => {
    ...
    try {
      const res = await api.patch(`communication/doubts/message/${msgId}/`, {
    ...
    <div style={{ padding: "20px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          >
            Ask questions to your teachers and get solutions.
          </p>
        </div>
        <button
              ...
              >
                <div>
                  <div style={{ fontWeight: 1000, fontSize: 16 }}>
                    {activeConv.subject || "General Doubt"}
                  </div>
                  <div
                    style={{ fontSize: 12, color: "#6b7280", fontWeight: 900 }}
                  >
                    With: {activeConv.teacher_name}
                  </div>
                </div>
                <div
                  style={{ fontSize: 12, color: "#6b7280", fontWeight: 900 }}
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      <button
                        disabled={
                          sending || (!messageText.trim() && !attachment)
                        }
                        onClick={sendMessage}
                        style={{
                          border: "none",
            ...
            >
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewDoubt({ ...newDoubt, teacher_id: e.target.value })
                  }
                  style={inputStyle}
                >
                  ...
                  {teachers.map((t) => (
                    <option key={t.id} value={t.id}>
                      {t.user_name} ({t.subjects?.[0]?.name || "Teacher"})
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setNewDoubt({ ...newDoubt, message: e.target.value })
                  }
