...
const Messaging = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      loadConversations({ status: "active" }),
    ])
      .then(([classRes]) => {
  ...
  const handleResolve = async () => {
    if (!activeConvId || !window.confirm("Mark this doubt as resolved?"))
      return;
    setResolving(true);
    try {
      ...
      <div style={{ ...cardStyle, padding: "20px" }}>
        ...
        >
          <div>
            ...
            >
              Resolve student questions and doubts.
            </p>
          </div>
            ...
            <>
              ...
              >
                <div>
                  ...
                  >
                    Doubt: {activeConv.subject || "General"}
                  </div>
                </div>
                {activeConv.is_active ? (
                  ...
                  <span
                    style={{ color: "#6b7280", fontWeight: 1000, fontSize: 14 }}
                  >
                    ✅ Resolved
                  </span>
                )}
