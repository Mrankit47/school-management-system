...
export default function TeacherAssignmentList() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setRows(
        (res.data || []).map((a) => ({ ...a, computed_status: getStatus(a) })),
      );
    } catch (e) {
  ...
  const classOptions = useMemo(
    () =>
      Array.from(
        new Set(
          rows.map((r) => `${r.class_name || ""}-${r.section_name || ""}`),
        ),
      ).filter(Boolean),
    [rows],
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            >
              Manage and track assignments created by you.
            </p>
          </div>
          <button
      ...
      >
              ...
              {loading ? (
                ...
                paged.map((r) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "16px", fontWeight: 1000 }}>
                      {r.total_marks}
                    </td>
                    <td style={{ padding: "16px" }}>
                      <span
        ...
        >
          <div
            style={{ color: palette.muted, fontWeight: 900, fontSize: "13px" }}
          >
            Showing {paged.length} of {filtered.length} assignments
          </div>
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ fontWeight: 1000 }}>{viewRow.subject}</div>
              </div>
              <div>
                <div style={labelStyle}>Class & Section</div>
                <div style={{ fontWeight: 1000 }}>
                  {viewRow.class_name}-{viewRow.section_name}
                </div>
              </div>
              <div>
                <div style={labelStyle}>Due Date</div>
                <div style={{ fontWeight: 1000, color: palette.danger }}>
                  {viewRow.due_date}
                </div>
              </div>
              <div>
                <div style={labelStyle}>Marks</div>
                <div style={{ fontWeight: 1000 }}>{viewRow.total_marks}</div>
              </div>
            </div>
            ...
            >
              ...
              >
                <h4 style={{ margin: 0, fontWeight: 1000 }}>
                  Student Submissions
                </h4>
                <span
                  style={{
      ...
      {editRow && (
        ...
        >
          ...
          >
            ...
            >
              <div>
                <div style={labelStyle}>Assignment Title</div>
                <input
                  value={editRow.title || ""}
                  onChange={(e) =>
                    setEditRow((p) => ({ ...p, title: e.target.value }))
                  }
                  style={inputStyle}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditRow((p) => ({ ...p, subject: e.target.value }))
                  }
                  style={inputStyle}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditRow((p) => ({ ...p, start_date: e.target.value }))
                  }
                  style={inputStyle}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditRow((p) => ({ ...p, due_date: e.target.value }))
                  }
                  style={inputStyle}
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  value={editRow.total_marks || ""}
                  onChange={(e) =>
                    setEditRow((p) => ({ ...p, total_marks: e.target.value }))
                  }
                  style={inputStyle}
                />
              </div>
              <div>
                <div style={labelStyle}>Submission Mode</div>
                <select
                  value={editRow.submission_type || "online"}
                  onChange={(e) =>
                    setEditRow((p) => ({
                      ...p,
            ...
            <div style={{ marginTop: "16px" }}>
              ...
              <textarea
                value={editRow.instructions || ""}
                onChange={(e) =>
                  setEditRow((p) => ({ ...p, instructions: e.target.value }))
                }
