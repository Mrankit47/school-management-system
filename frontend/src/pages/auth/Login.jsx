...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center px-4 sm:px-6 md:px-8 py-10 sm:py-12 font-inter relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          {school.logo ? (
            <>
              <img
                src={school.logo}
                alt={school.name}
                className="w-16 h-16 rounded-2xl mx-auto mb-4 shadow-xl object-contain"
                onError={(e) => {
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight px-2">
            {school.name}
          </h1>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white rounded-3xl shadow-2xl shadow-slate-200/50 p-6 sm:p-8 md:p-10 animate-in fade-in zoom-in-95 duration-500 delay-150">
          <div className="mb-8">
